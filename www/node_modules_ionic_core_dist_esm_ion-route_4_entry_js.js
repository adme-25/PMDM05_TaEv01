...
const _writeNavState = /*#__PURE__*/function () {
  var _ref = (0,C_Users_memen_Desktop_2_FP_Prog_Multimedia_y_Disp_Moviles_Tareas_PMDM05_TaEv01_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root, chain, direction, index, changed = false, animation) {
    try {
      ...
      changed = yield _writeNavState(result.element, chain, direction, index + 1, changed, animation); // once all nested outlets are visible let's make the parent visible too,
...
const readNavState = /*#__PURE__*/function () {
  var _ref2 = (0,C_Users_memen_Desktop_2_FP_Prog_Multimedia_y_Disp_Moviles_Tareas_PMDM05_TaEv01_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root) {
    const ids = [];
    let outlet;
